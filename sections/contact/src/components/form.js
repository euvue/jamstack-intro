...
const Form = () => {
    ...
    return (
        ...
        'PENDING' && styles.pending}`} onSubmit=
        {handleSubmit}>
            ...
            type="email" name="email" value={state.email} onChange=
            {updateFieldValue('email')}/>
            </label>
            <label className={styles.label}>
            Subject 
            <input className={styles.input}
            type="text" name="subject" value={state.subject} onChange=
            {updateFieldValue('subject')}/>
            </label>
            <label className={styles.label}>
            Body
            <textarea className={styles.input} name="subject"
            value={state.body} onChange=
            {updateFieldValue('body')}/>
            </label>
